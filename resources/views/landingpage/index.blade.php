        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse justify-content-center justify-content-lg-end" id="navbarCollapse">
                <ul
                    ...
                    <li class="nav-item">
                        <a href="#page-top" class="nav-link fw-semibold text-dark">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a href="#alumni" class="nav-link fw-semibold text-dark">Alumni</a>
                    </li>
                    <li class="nav-item">
                        <a href="#kontak" class="nav-link fw-semibold text-dark">Kontak</a>
                    </li>
