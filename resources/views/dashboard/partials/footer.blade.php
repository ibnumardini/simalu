      ...
      <div class="col-12 col-lg-auto mt-3 mt-lg-0">
        <ul class="list-inline list-inline-dots mb-0">
          ...
          <li class="list-inline-item">
            ...
            by <a class="link-secondary" href="https://fatkur.id">Ibnu Mardini</a> & all the coolest <a
              class="link-secondary" href="https://github.com/ibnumardini/simalu/graphs/contributors"
